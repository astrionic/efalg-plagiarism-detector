...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            final String[] programs = Reader.readProgramFiles(INPUT_DIRECTORY);
            ...
            final var keywords = Reader.readKeywords(KEYWORDS_FILE_PATH);
            ...
            final var separators = Reader.readSeparators(SEPARATORS_FILE_PATH);
            ...
            final var programNames = Reader.readProgramNames(INPUT_DIRECTORY);
